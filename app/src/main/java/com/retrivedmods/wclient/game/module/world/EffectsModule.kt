...
class EffectsModule : Module("effects", ModuleCategory.World) {
    ...
    private val badOmen by boolValue("Bad Omen", true)
    ...
    private val strength by boolValue("Strength", true)
    private val swiftness by boolValue("Swiftness", false)
    private val villageHero by boolValue("Village Hero", true)
    ...
    private val nightVision by boolValue("Night Vision", true)
