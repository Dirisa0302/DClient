...
object WColors {
    // Primary Blues (Xanh nước biển chủ đạo)
    val Primary = Color(0xFF0099FF)
    val PrimaryLight = Color(0xFF33BBFF)
    val PrimaryDark = Color(0xFF0077CC)
    val OnPrimary = Color(0xFFFFFFFF)

    // Secondary (Slate trung tính)
    val Secondary = Color(0xFF64748B)
    val SecondaryVariant = Color(0xFF475569)
    val SecondaryLight = Color(0xFF94A3B8)
    val OnSecondary = Color(0xFFFFFFFF)

    // Accent Cyan / Xanh ngọc tạo hiệu ứng sáng
    val Accent = Color(0xFF00D4FF)
    val AccentLight = Color(0xFF66E5FF)
    val AccentDark = Color(0xFF0099B8)

    val Background = Color(0xFF0B0F19)
    val Surface = Color(0xFF111827)
    val SurfaceVariant = Color(0xFF1F2937)
    val SurfaceContainer = Color(0xFF161E2E)
    ...
    val Border = Color(0xFF26334D)
    val BorderLight = Color(0xFF3B4D73)

    val Overlay = Color(0x80000000)
}

object ClickGUIColors {
    val PrimaryBackground = Color(0xFF0B0F19)
    val SecondaryBackground = Color(0xFF111827)
    ...
    val PanelBackground = Color(0xF0111827)
    val PanelBorder = Color(0x600099FF)

    val ModuleEnabled = AccentColor
    val ModuleDisabled = Color(0xFF1F2937)

    val SliderTrack = Color(0xFF1F2937)
